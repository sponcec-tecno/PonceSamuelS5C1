...
//	double vyS0 = -0.00002;//Esta la usé, pero el Sol era arrastrado hacia abajo
	...
	//Euler
	//Earth
	doc(vxT_e, "myout_vxT_e.dat");
	doc(xT_e, "myout_xT_e.dat");
	doc(vyT_e, "myout_vyT_e.dat");
	doc(yT_e, "myout_yT_e.dat");
	//Sun
	doc(vxS_e, "myout_vxS_e.dat");
	doc(xS_e, "myout_xS_e.dat");
	doc(vyS_e, "myout_vyS_e.dat");
	doc(yS_e, "myout_yS_e.dat");

	//Leap-frog
	//Earth
        doc(vxT_lf, "myout_vxT_lf.dat");
        doc(xT_lf, "myout_xT_lf.dat");
        doc(vyT_lf, "myout_vyT_lf.dat");
        doc(yT_lf, "myout_yT_lf.dat");
        //Sun
        doc(vxS_lf, "myout_vxS_lf.dat");
        doc(xS_lf, "myout_xS_lf.dat");
        doc(vyS_lf, "myout_vyS_lf.dat");
        doc(yS_lf, "myout_yS_lf.dat");
	return 0;
}
